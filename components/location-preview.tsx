      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <motion.div 
            ...
            className="relative h-[500px] lg:h-[650px] rounded-[3rem] overflow-hidden shadow-2xl bg-white border-8 border-white"
          >
            <iframe
            ...
            {/* Floating Map Label */}
            <div className="absolute top-8 left-8 bg-white/90 backdrop-blur-md px-6 py-4 rounded-2xl shadow-2xl border border-white/20">
              <div className="flex items-center gap-3">
                <div className="w-3 h-3 rounded-full bg-electric-blue animate-pulse" />
                <span className="font-black text-deep-navy uppercase tracking-widest text-xs">Live Facility Status</span>
              </div>
            </div>
          </motion.div>
          ...
          <div className="order-1 lg:order-2">
            ...
            >
              ...
              <h2 className="text-4xl md:text-6xl font-black text-deep-navy mt-3 mb-8 tracking-tight leading-[1.1]">
                Positioned for <br />
            ...
            <div className="grid grid-cols-1 gap-6 mb-12">
              {[
                ...
                <motion.div 
                  ...
                  className="flex items-center gap-6 p-6 rounded-[2rem] bg-white border border-slate-100 shadow-sm hover:shadow-xl transition-all group hover:border-electric-blue/30"
                >
                  <div className="w-14 h-14 rounded-2xl bg-slate-50 flex items-center justify-center flex-shrink-0 transition-all group-hover:bg-electric-blue group-hover:text-white group-hover:rotate-6 shadow-sm">
                    <item.icon className="h-6 w-6" />
                  </div>
                  <div>
                    <p className="text-xs font-black text-slate-400 uppercase tracking-[0.2em] mb-1">{item.title}</p>
                    <p className="text-lg font-bold text-deep-navy">{item.text}</p>
                  </div>
                </motion.div>
              ))}
            </div>
