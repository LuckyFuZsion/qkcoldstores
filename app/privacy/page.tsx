  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle="QK Cold Stores (Marston) Ltd - how we collect, use, and protect your personal data."
        eyebrow={
              ...
              <Card className="border-border/50 bg-deep-navy text-white">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2 text-ice-blue/90">
                    ...
                    <p>
                      <a href="tel:+441400259300" className="text-electric-blue hover:underline">
                        01400 259300
                      </a>
                    </p>
                  </div>
